...
function convertTemperature(temperature, scale) {
  if (scale === "C") {
    ...
    return "If you are looking for Kelvin, I don't know where he is"
  }
}
...
function calculateGrade(score) {
  score = Math.floor(score); // a mean teacher who doesn't round up grades
